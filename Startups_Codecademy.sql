DROP DATABASE IF EXISTS startups;
...
("fsociety", "Brooklyn", "Games", "5", NULL, NULL, 2014, "Stealth", "Elliot Alderson", "Fun Society Arcade"),
...
("Magic Heap", "Fort Launderdale", "Augmented Reality", "500", 1800000000, 8000000000, 2013, "D", "Johnny Malkovich", "¯\_(ツ)_/¯"),
...
("REBU", "San Francisco", "Logistics", "15000", 11500000000, 70000000, 2009, "G", "Kravis Talanicks", "Ridesharing Platform"),
...
("Everyotherday.me", "San Francisco", "Mobile", "35", NULL, NULL, 2012, "Seed", "Jeremy Lin", "Journal that Captures the Special Moment"),
("Frontsby", "San Francisco", NULL, NULL, NULL, NULL, 2013, "Seed", "Olivia Plath", NULL),
("2Smart2Host", "Brookly", "Date Analytics", "4", 380000, NULL, 2014, "Acquired", "Evan Nails", "Dynamic Pricing for Vacation Rentals"),
...
("Earendil", "Los Angeles", "Mobile", "2", 50000, 200000, 2009, "Seed", "Kent Bergensen", "Flashlight App"),
...
("CyChare", "Seattle", "Social", "11", 300000, 10000000, 2015, "B", "Cathy Zhou", "Bicycle Sharing Service"),
...
("Friend, Where Is My Vehicle", "SaaS", "Cloud Computing", "8", 1800000, 2000000, 2016, "A", "Roland Tavurner", "GPS Services"),
...
("ScoopAble", "Denver", "Social", "14", 1000000, 7600000, 2016, "A", "Zoe Gfell", "Yogurt Finder"),
("YoBert", "New York", "Education", "31", 800000, 40000000, 2016, "Acquired", "Ernie Dzeda", "Sesame Street Themed Educational App"),
